...
#define dbm_delete(db,dkey) fatalx(0, "dbz doesn't implement delete")
#define dbm_store(db,dkey,dcontent,flags) store(dkey,dcontent)
#define dbm_close(db) dbmclose()
#define dbm_firstkey(db) (fatalx(0, "dbz doesn't implement traversal"),fetch())
#define nextkey() (fatalx(0, "dbz doesn't implement traversal"),fetch())
#define dbm_nextkey(db) (fatalx(0, "dbz doesn't implement traversal"),fetch())
#ifdef HAS_NDBM
#undef HAS_NDBM
#endif
#ifndef HAS_ODBM
