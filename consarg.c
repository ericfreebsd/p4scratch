...
ARG *
make_split(register STAB *stab, register ARG *arg, ARG *limarg)
{
    register SPAT *spat;
...
ARG *
make_op(int type, int newlen, ARG *arg1, ARG *arg2, ARG *arg3)
{
    register ARG *arg;
    register ARG *chld;
...
ARG *
addflags(int i, int flags, register ARG *arg)
{
...
ARG *
maybelistish(int optype, ARG *arg)
{
    ARG *tmparg = arg;
...
ARG *
stab2arg(int atype, register STAB *stab)
{
    register ARG *arg;
...
ARG *
cval_to_arg(register char *cval)
{
    register ARG *arg;
...
ARG *
make_match(int type, ARG *expr, SPAT *spat)
{
    register ARG *arg;
...
static int
nothing_in_common(ARG *arg1, ARG *arg2)
{
...
static int
arg_common(register ARG *arg, int exprnum, int marking)
{
    register int i;
...
static int
spat_common(register SPAT *spat, int exprnum, int marking)
{
