 ...
 */
int
regexec(register regexp *prog, char *stringarg, register char *strend, char *strbeg, int minend, STR *screamer, int safebase)
{
	register char *s;
	register int i;
	register char *c;
	...
	if (prog == NULL || string == NULL) {
		fatalx(0, "NULL regexp parameter");
		return(0);
	}
